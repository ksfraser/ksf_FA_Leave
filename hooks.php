 ...
 * 
 * @package KsfFA_ksf_FA_Leave
 * @version 2.4.3
 */

define('SS_ksf_FA_Leave', 119 << 8);
...
class hooks_ksf_FA_Leave extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_LeaveVIEW'] = array(
            SS_ksf_FA_Leave | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_LeaveMANAGE'] = array(
            SS_ksf_FA_Leave | 2, 
            _("Manage ")
        );

<?php
/**
 * ksf_FA_Leave Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_Leave', 100 << 8);

class hooks_ksf_FA_Leave extends hooks {
    var $module_name = 'ksf_FA_Leave';
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_Leave] = _("");
        $security_areas['SA_ksf_FA_LeaveVIEW'] = array(SS_ksf_FA_Leave | 1, _("View "));
        $security_areas['SA_ksf_FA_LeaveMANAGE'] = array(SS_ksf_FA_Leave | 2, _("Manage "));
